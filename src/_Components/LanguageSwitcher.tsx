                ...
                <div className="language-modal-content">
                    ...
                    {/* <div className="language-option">
                        <input
                            ...
                            className="language-radio"
                            onChange={(e) => setSelectedLang(e.target.value)}
                            checked={selectedLang === "tz"}
                        />
                        <label htmlFor="lang-tz" className="language-label">
                            <div className="language-flag tamazight-flag"></div>
                            <span className="language-name">Tamazight</span>
                        </label>
                    </div> */}
                </div>
